...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RenameContractsCodeFixProviderDyatlov)), Shared]
public class RenameContractsCodeFixProviderDyatlov : CodeFixProvider
{
    ...
    public sealed override ImmutableArray<string> FixableDiagnosticIds => [RenameContractsAnalyzerDyatlov.DiagnosticId];
    ...
    public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        var renameDescription = string.Format(
            CodeFixTitle.ToString(),
            changes.Value.CurrentName,
            changes.Value.NewName);
    ...
    private static (string CurrentName, string NewName)? GetChanges(Document document, RecordDeclarationSyntax dto)
    {
        ...
        var scanFolderIndex = Array.FindIndex(folders, f => f.Equals(RenameContractsAnalyzerDyatlov.ScanFolder));
